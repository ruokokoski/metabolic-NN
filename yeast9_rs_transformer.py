...
DATA_PATH = "./data/2025-10-10_yeast9_training_data_100000_samples.csv"
...
if __name__ == "__main__":
    ...
    train_loss, test_loss, model, optimizer = train_model(d_model, n_heads, n_layers, d_ff, num_epochs, learning_rate, dropout, model_name, output_sample_ratio=0.1)
