# Difference to v01: 3 pos. outputs 'EX_co2_e_flux', 'EX_h2o_e_flux', 'Biomass_Ecoli_core_flux'
...
output_labels = ['EX_co2_e_flux', 'EX_h2o_e_flux', 'Biomass_Ecoli_core_flux']

today = date.today().isoformat()
pic_dir = f"./pics/{today}"
os.makedirs(pic_dir, exist_ok=True)
model_name = "ecoli_core_v2"
